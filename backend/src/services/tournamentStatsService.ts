...
//       .leftJoin('players as tp1', 'g.player1_id', 'tp1.id')
//       .leftJoin('players as tp2', 'g.player2_id', 'tp2.id')
//       .select(
//         'd.id as division_id',
...
//     const players: DatabasePlayer[] = await this.knex('players')
...
//     const playerDbIds = await this.knex('players')
//       .select('id', 'player_id')
//       .where('tournament_id', tournamentId)
//       .where('division_id', divisionId)
...
//     const playerResult = await this.knex('players')
//       .select('id')
//       .where({
