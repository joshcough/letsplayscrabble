import { PlayerStats, Division, RawPlayer, DivisionStats } from "@shared/types/tournament";
...
export function calculateStatsFromGames(games: GameForStats[]): DivisionStats {
