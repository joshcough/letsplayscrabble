...
//
  ...
  // Replace the commented out calculateStatsFromGames function with this:
  export function calculateStatsFromGames(gamesWithPlayers: GameWithPlayers[], divisionId: number): DivisionStats {
