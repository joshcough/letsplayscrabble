...
themes :: Map.Map String Theme
themes = Map.fromFoldable
  [ Tuple "modern" modernTheme
  , Tuple "scrabble" scrabbleTheme
  , Tuple "july4" july4Theme
  , Tuple "original" originalTheme
  ]

-- | Get theme by name, defaulting to scrabble theme
getTheme :: String -> Theme
getTheme themeName = fromMaybe scrabbleTheme (Map.lookup themeName themes)
