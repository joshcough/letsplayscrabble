...
var sortPlayers = function (v) {
    ...
    throw new Error("Failed pattern match at Stats.PlayerStats (line 199, column 1 - line 199, column 66): " + [ v.constructor.name ]);
};
var eqSortType = {
    eq: function (x) {
        return function (y) {
    ...
    return function (games) {
        ...
        var accumulateBye = function (stats) {
            return function (game) {
                ...
                throw new Error("Failed pattern match at Stats.PlayerStats (line 127, column 9 - line 138, column 14): " + [ byeScore.constructor.name ]);
            };
        };
